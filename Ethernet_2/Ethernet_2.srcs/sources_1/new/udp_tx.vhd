        ...
        if rst_n = '0' then
            ...
            case state is
                ...
                when IP_HEADER =>
                    gmii_txen  <= '1';
                    byte_cnt   <= byte_cnt + 1;
                    ip_tot_len := resize(unsigned(tx_len), 16) + 28;
                    
                    case byte_cnt is
                        when 0  => current_byte := x"45";
                        when 1  => current_byte := x"00";
                        when 2  => current_byte := std_logic_vector(ip_tot_len(15 downto 8));
                        when 3  => current_byte := std_logic_vector(ip_tot_len(7 downto 0));
                        ...
                        when 10 => current_byte := x"00"; -- Checksum Bypass
                ...
                when UDP_HEADER =>
                    gmii_txen <= '1';
                    byte_cnt  <= byte_cnt + 1;
                    udp_len   := resize(unsigned(tx_len), 16) + 8;
                    ...
                    case byte_cnt is
                        ...
                        when 4      => current_byte := std_logic_vector(udp_len(15 downto 8));
                        when 5      => current_byte := std_logic_vector(udp_len(7 downto 0));
